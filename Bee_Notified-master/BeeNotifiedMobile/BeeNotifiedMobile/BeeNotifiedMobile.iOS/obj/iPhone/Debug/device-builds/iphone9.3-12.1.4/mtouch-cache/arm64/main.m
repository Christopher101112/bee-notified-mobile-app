...
extern void *mono_aot_module_BeeNotifiedMobile_iOS_info;
...
extern void *mono_aot_module_BeeNotifiedMobile_info;
...
extern void *mono_aot_module_PlacesSearchBar_info;
extern void *mono_aot_module_Humanizer_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_BeeNotifiedMobile_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_BeeNotifiedMobile_info);
	...
	mono_aot_register_module (mono_aot_module_PlacesSearchBar_info);
	mono_aot_register_module (mono_aot_module_Humanizer_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "BeeNotifiedMobile.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
